 ...
 ********************************************/
  ...
  */
	 ...
	 *    Use #plist_get_uint_val or #plist_get_int_val to get the unsigned or signed value.
	 */
	PLIST_API_MSC plist_t plist_new_int(int64_t val);
	 ...
	 */
	PLIST_API_MSC uint8_t plist_dict_get_bool(plist_t dict, const char *key);
	 ...
	 */
	PLIST_API_MSC int64_t plist_dict_get_int(plist_t dict, const char *key);
	 ...
	 * @return Signed integer value depending on the value of the node.
	 */
	PLIST_API_MSC uint64_t plist_dict_get_uint(plist_t dict, const char *key);
	 ...
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_item(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 *     any entry with given key or alt_source_key.
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_bool(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 *     any entry with given key or alt_source_key.
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_int(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 *     any entry with given key or alt_source_key.
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_uint(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_data(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 */
	PLIST_API_MSC plist_err_t plist_dict_copy_string(plist_t target_dict, plist_t source_dict, const char *key, const char *alt_source_key);
	 ...
	 */
	PLIST_API_MSC void plist_get_int_val(plist_t node, int64_t * val);
	 ...
	 * @param val the signed integer value
	 */
	PLIST_API_MSC void plist_set_int_val(plist_t node, int64_t val);
	 ...
	 * @note Use plist_mem_free() to free the allocated memory.
	 */
	PLIST_API_MSC plist_err_t plist_to_openstep(plist_t plist, char **plist_openstep, uint32_t* length, int prettify);
	 ...
	 * @return PLIST_ERR_SUCCESS on success or a #plist_err_t on failure
	 */
	PLIST_API_MSC plist_err_t plist_from_openstep(const char *openstep, uint32_t length, plist_t * plist);
	 ...
	 * @return PLIST_ERR_SUCCESS on success or a #plist_err_t on failure
	 */
	PLIST_API_MSC plist_err_t plist_from_memory(const char *plist_data, uint32_t length, plist_t *plist, plist_format_t *format);
	 ...
	 * @return PLIST_ERR_SUCCESS on success or a #plist_err_t on failure
	 */
	PLIST_API_MSC plist_err_t plist_read_from_file(const char *filename, plist_t *plist, plist_format_t *format);
	 ...
	 */
	PLIST_API_MSC plist_err_t plist_write_to_string(plist_t plist, char **output, uint32_t* length, plist_format_t format, plist_write_options_t options);
	 ...
	 */
	PLIST_API_MSC plist_err_t plist_write_to_stream(plist_t plist, FILE* stream, plist_format_t format, plist_write_options_t options);
	 ...
	 * @note Use plist_mem_free() to free the allocated memory.
	 */
	PLIST_API_MSC plist_err_t plist_write_to_file(plist_t plist, const char *filename, plist_format_t format, plist_write_options_t options);
	 ...
	 */
	PLIST_API_MSC void plist_print(plist_t plist);
 ...
 */
	 ...
	 */
	PLIST_API_MSC int plist_int_val_is_negative(plist_t intnode);
	 ...
	 */
	PLIST_API_MSC int plist_int_val_compare(plist_t uintnode, int64_t cmpval);
	 ...
	 */
	PLIST_API_MSC void plist_sort(plist_t plist);
	 ...
	 */
	PLIST_API_MSC void plist_set_debug(int debug);
	 ...
	 */
	 PLIST_API_MSC const char* libplist_version();
